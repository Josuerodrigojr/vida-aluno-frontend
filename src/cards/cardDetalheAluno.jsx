...
import React from 'react';
  ...
  function CardAlunoDetalhe(props) {
    return (
      ...
      <CCardBody className="p-4">
        <CCardTitle className="text-lg font-bold text-center">{props.primeironome + " " + props.segundonome}</CCardTitle>
        <CCardText>
  ...
  export default CardAlunoDetalhe